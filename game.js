...
const CHANGELOG = [
  {
    ...
    changes: [
      ...
      'Food rate no longer shows "0/s" when negative — you can actually see how fast goblins are eating now.',
      'Switching browser tabs no longer loses minutes of production.',
      'Intro story won\'t replay after franchising.',
